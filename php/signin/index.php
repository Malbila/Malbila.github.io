                    ...
                    <div id="root">
                        <div id="topnav" class="topnav">
                            <a id="home_link" class="navbar-brand" href="../../">
                                <img src="../../Images/brand.jpg" width = "50" height = "50" alt="Logo du site">  
                                Le-BDCI
                            </a>
    ...
    <div class="container content">
        <div class="row">
            ...
            <div class="col text-center">
                <br /><br /><br /><h1>Welcome to Info School</h1> <br /><br />
                <div>
                    <p>
                        <form action="signinDB.php" method="post">
                            <div class="input-group mb-4 inputWith text-center">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><img src="../../Images/pwd.png" class="bordure" width = "23" height = "23" alt="Logo user"></span>
                                </div>
